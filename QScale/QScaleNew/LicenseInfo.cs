...
namespace QScaleNew
{
    public class LicenseInfo
    {
        ...
        public LicenseInfo(string LicenseKey, string ApplicationName)
        {
            ...
            string data = this.GetBiosInfo() + this.GetOperatingSystemInfo() + this.GetComputerSystemInfo() + this.GetMotherboardInfo() + this.GetProcessorInfo() + this.GetLogicalDiskInfo() + this.GetVideoControllerInfo();// +this.GetNetworkAdapterInfo();
