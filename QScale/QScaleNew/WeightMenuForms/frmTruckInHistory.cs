...
{
    public partial class frmTruckInHistory : Form
    {
        ...
        public frmTruckInHistory()//frmMain MainForm
        {
            InitializeComponent();
            //mainForm = MainForm;
            AddEventHandlers();
        ...
        private void PrimaryWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                string sqlSelectData = "select TruckInId as Id, ClientName, CompanyName, TruckNo, DriverName, ChallanNo, TruckInDate from qryTruckInHistory";
