...
{
    public partial class frmTruckOutHistory : Form
    {
        ...
        public frmTruckOutHistory()//frmMain MainForm
        {
            InitializeComponent();
            //mainForm = MainForm;
            AddEventHandlers();
        ...
        private void AddEventHandlers()
        {
            ...
            //txtID.TextChanged += FilterDataGridView; //TextBoxName must be equal to datasource column name
            txtClientName.TextChanged += FilterDataGridView; //TextBoxName must be equal to datasource column name
            txtCompanyName.TextChanged += FilterDataGridView; //TextBoxName must be equal to datasource column name
            txtTruckNo.TextChanged += FilterDataGridView; //TextBoxName must be equal to datasource column name
            txtDriverName.TextChanged += FilterDataGridView; //TextBoxName must be equal to datasource column name
            txtChallanNo.TextChanged += FilterDataGridView; //TextBoxName must be equal to datasource column name
        ...
        private void PrimaryWork(object sender, DoWorkEventArgs e)
        {
            try
            {
               ...
               // string sqlSelectData = "select * from qryTruckOutHistory";

                string sqlSelectData = "select TruckOutId as ID, TruckNo, DriverName, ClientName, CompanyName, TruckOutDate, ChallanNo from qryTruckOutHistory";
