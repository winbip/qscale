...
namespace QScaleNew.MasterSetupForms
{
    public partial class frmClientList : Form
    {
        ...
        {
            InitializeComponent();
            this.Icon = Properties.Resources.CustomerListBlackIco32;
            AddEventHandlers();
        }
        ...
        private void AddEventHandlers()
        {
            ...
            txtAddress.TextChanged += FilterDataGridView; //TextBoxName must be equal to datasource column name
            txtMobileNo.TextChanged += FilterDataGridView; //TextBoxName must be equal to datasource column name
        ...
        private void PrimaryWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                string sqlSelectData = "select * from qryClientList where ClientId>0";
        ...
        private void ExportDataToExcel(object sender, EventArgs e)
        {
            try
            {
               ...
               // DataExporter.ExportToExcel.Export(dgData, "");
        ...
        {
            selectedEntityId = (int)dgData.CurrentRow.Cells[0].Value;
