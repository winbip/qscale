...
namespace QScaleNew.MasterSetupForms
{
    public partial class frmProductList : Form
    {
        ...
        private void AddEventHandlers()
        {
            ...
            txtProductName.TextChanged += FilterDataGridView; //TextBoxName must be equal to datasource column name
        ...
        private void PrimaryWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                string sqlSelectData = "Select ProductId, ProductName from tblProducts order by ProductName asc";
