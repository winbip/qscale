...
{
    public partial class frmPendingTruckList : Form
    {
        ...
        private void PrimaryWork(object sender, DoWorkEventArgs e)
        {
            try
            {
                ...
                string sqlSelectData="select * from qryPendingTruckList";
        ...
        {
            pSelectedEntityId = (int)dgData.CurrentRow.Cells["TruckInId"].Value;
