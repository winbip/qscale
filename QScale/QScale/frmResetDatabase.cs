...
namespace QScale
{
    public partial class frmResetDatabase : Form
    {
        ...
        {
            ////Note: This is SQL string code template to reset database tables.
            //list.Add("*tblRawItem");
            ...
            //tblClientType
            list.Add("*tblClientType");
            list.Add("DELETE * FROM tblClientType");
            list.Add("ALTER TABLE tblClientType ALTER COLUMN ClientTypeId  AUTOINCREMENT(0,1)");
            list.Add("INSERT INTO tblClientType(ClientTypeName) VALUES('')");
            list.Add("#tblClientType");
